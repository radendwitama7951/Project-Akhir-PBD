...
const sql_createTBMantan = fs.readFileSync("scripts/initData.mantan.sql").toString();

const sql_addData = `/*	Menambah data*/
...
database.query(sql_createTBMantan, [values], (error, result) => {
		if (error) throw error;
		console.log("Database: Ok");
